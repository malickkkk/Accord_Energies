...
if (!isset($_SESSION['UtilisateurID']) || $_SESSION['Role'] !== 'admin') {
...
try {
    ...
    // Traitement de la soumission du formulaire de création d'utilisateur
    if (isset($_POST['creer_utilisateur'])) {
        ...
        $requete = $pdo->prepare("INSERT INTO utilisateurs (nom, prenom, email, password, Role) VALUES (:nom, :prenom, :email, :password, :role)");
    ...
    // Traitement de la soumission du formulaire de modification d'utilisateur
    if (isset($_POST['modifier_utilisateur'])) {
        ...
        $requete = $pdo->prepare("UPDATE utilisateurs SET nom = :nom, prenom = :prenom, email = :email, password = :password, Role = :role WHERE utilisateurID = :utilisateurID");
    ...
    // Code pour créer une intervention
    ...
    // Code pour modifier une intervention
